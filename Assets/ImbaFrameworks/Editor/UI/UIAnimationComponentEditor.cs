...
namespace Imba.Editor.UI
{
    ...
    public class UIAnimationComponentEditor : UIBaseEditor
    {
        ...
        private void DrawBehaviors()
        {
            ...
            GUILayout.Space(10);
            DrawBehavior("Loop Behavior", Target.LoopBehavior, m_loopBehavior);
            GUILayout.Space(10);
            //EditorGUI.indentLevel = indent;
        }
        
        private void DrawBehavior(string behaviorName, UIAnimationBehavior behavior, SerializedProperty behaviorProperty)
        {
        ...
        private void DrawPreviewAnimationButtons(SerializedObject serializedObject, UIAnimationComponent view, UIAnimationBehavior animationBehavior)
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                {
                   PreviewAnim(animationBehavior.Animation, view);
                }
        ...
        private void DrawBehaviorAnimation(UIAnimationBehavior behavior, SerializedProperty animationProperty, SerializedProperty instantAnimationProperty)
        {
            ...
            if (instantAnimationProperty != null)
            {
                ...
                isInstant = instantAnimationProperty.boolValue;
            }
