...
namespace Imba.UI
{
	...
	public abstract class UIPopup : UIBaseComponent
    {
        ...
        public UIPopupController Controller
        {
            get
            {
                return GetComponent<UIPopupController>();   
            }
        }
        ...
        public void Initialize(object p)
        {
        ...
        public void Show(object p = null)
        {
            ...
            UIManager.DebugLog("Show popup " + name, this);
            ...
            {
                UIManager.DebugLog("Popup was shown " + name, this);
