...
namespace Imba.UI
{
    ...
    public class UIAnimationComponent : UIBaseComponent
    {
        ...
        public UIAnimationBehavior ShowBehavior = new UIAnimationBehavior(AnimationType.Show);

        public UIAnimationBehavior HideBehavior = new UIAnimationBehavior(AnimationType.Hide);

        public UIAnimationBehavior LoopBehavior = new UIAnimationBehavior(AnimationType.Loop);
        ...
        public Vector3 CurrentStartPosition { get { return StartPosition; } }
        ...
        public void Show()
        {
            ...
            if (!this.ShowBehavior.Animation.Enabled && !instantAction)
            {
                Debug.LogError("You are trying to SHOW the (" + name +
                               ") View, but you did not enable any SHOW animations. Enable at least one SHOW animation in order to fix this issue.");
        ...
        public void ResetLoopAnimation()
        {
            ...
            UIAnimator.ResetAnimations(RectTransform, AnimationType.Loop);
        }
        ...
        public void Hide(bool instantHide = false)
        {
            ...
            if (!this.HideBehavior.Animation.Enabled && !instantAction)
            {
                Debug.LogError("You are trying to HIDE the (" + name +
                               ") UIView, but you did not enable any HIDE animations. Enable at least one HIDE animation in order to fix this issue.");
        ...
        private IEnumerator ShowEnumerator(bool instantAction)
        {
            ...
            UIAnimator.StopAnimations(RectTransform,
                this.ShowBehavior.Animation.AnimationType); //stop any SHOW animations
            ...
            //MOVE
            Vector3 moveFrom =
                UIAnimator.GetAnimationMoveFrom(RectTransform, this.ShowBehavior.Animation, Vector3.zero);
            ...
            if (!this.ShowBehavior.Animation.Move.Enabled || instantAction)
                ResetPosition();
            UIAnimator.Move(RectTransform, this.ShowBehavior.Animation, moveFrom, moveTo,
            ...
            if (!this.ShowBehavior.Animation.Rotate.Enabled || instantAction)
                ResetRotation();
            UIAnimator.Rotate(RectTransform, this.ShowBehavior.Animation, rotateFrom, rotateTo,
            ...
            UIAnimator.Scale(RectTransform, this.ShowBehavior.Animation, scaleFrom, scaleTo,
            ...
            UIAnimator.Fade(RectTransform, this.ShowBehavior.Animation, fadeFrom, fadeTo,
        ...
        {
            UIAnimator.StopAnimations(RectTransform,
                this.HideBehavior.Animation.AnimationType); //stop any HIDE animations

            //MOVE
            Vector3 moveFrom =
                UIAnimator.GetAnimationMoveFrom(RectTransform, this.HideBehavior.Animation, Vector3.zero);
            ...
            if (!this.HideBehavior.Animation.Move.Enabled || instantAction)
                ResetPosition();
            UIAnimator.Move(RectTransform, this.HideBehavior.Animation, moveFrom, moveTo,
            ...
            if (!this.HideBehavior.Animation.Rotate.Enabled || instantAction)
                ResetRotation();
            UIAnimator.Rotate(RectTransform, this.HideBehavior.Animation, rotateFrom, rotateTo,
            ...
            if (!this.HideBehavior.Animation.Scale.Enabled || instantAction)
                ResetScale();
            UIAnimator.Scale(RectTransform, this.HideBehavior.Animation, scaleFrom, scaleTo,
            ...
            float fadeTo = UIAnimator.GetAnimationFadeTo(this.HideBehavior.Animation, 1f);
            if (!this.HideBehavior.Animation.Fade.Enabled || instantAction)
            {
                ResetAlpha();
            }

            UIAnimator.Fade(RectTransform, this.HideBehavior.Animation, fadeFrom, fadeTo,
            ...
            {
                yield return
                    new WaitForSecondsRealtime(this.HideBehavior.Animation.TotalDuration +
