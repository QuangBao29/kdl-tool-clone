...
//            Vector3 rotationB = RotateLoopRotationB(animation, startValue);
        ...
        public static void ResetAnimations(RectTransform target, AnimationType animationType, bool complete = true)
        {

            DOTween.Rewind(GetTweenId(target, animationType, AnimationAction.Move), complete);
            DOTween.Rewind(GetTweenId(target, animationType, AnimationAction.Rotate), complete);
            DOTween.Rewind(GetTweenId(target, animationType, AnimationAction.Scale), complete);
            DOTween.Rewind(GetTweenId(target, animationType, AnimationAction.Fade), complete);
        }
