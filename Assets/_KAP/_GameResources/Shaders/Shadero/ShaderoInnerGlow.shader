...
Shader "Shadero Customs/ShaderoInnerGlow"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_InnerGlowHQ_Intensity_1("_InnerGlowHQ_Intensity_1", Range(1, 16)) = 0.5897436
_InnerGlowHQ_Size_1("_InnerGlowHQ_Size_1", Range(1, 16)) = 0.7394871
